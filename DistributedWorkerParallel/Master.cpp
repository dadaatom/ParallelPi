...
int main(int argc, char* argv[]) 
{
    ...
    MPI_Comm_spawn("Child", MPI_ARGV_NULL, numWorkers, MPI_INFO_NULL, 0, MPI_COMM_SELF, &comm, MPI_ERRCODES_IGNORE); // <- Doesn't create workers?
    MPI_Comm_size(comm, &numChild); //Updates task count after Comm_spawn
